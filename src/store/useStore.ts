            ...
            items: [
              {
                product: {
                  ...
                  stockCount: 50,
                  tags: ["BESTSELLER"],
                  description: "A luxury essence for radiant skin.",
                  details: ["Hydrating", "Vegan"],
                  isNew: false,
                  isBestseller: true,
                  isSale: false,
                  isSoldOut: false,
              ...
              },
              {
                product: {
                  ...
                  stockCount: 20,
                  tags: ["NEW"],
                  description: "Premium silk wrap for hair protection.",
                  details: ["100% Silk", "Adjustable"],
                  isNew: true,
                  isBestseller: false,
                  isSale: false,
                  isSoldOut: false,
            ...
            items: [
              {
                product: {
                  ...
                  stockCount: 15,
                  tags: ["SALE"],
                  description: "Deeply nourishing night cream.",
                  details: ["Overnight repair", "Fragrance-free"],
                  isNew: false,
                  isBestseller: false,
                  isSale: true,
                  isSoldOut: false,
            ...
            items: [
              {
                product: {
                  ...
                  stockCount: 30,
                  tags: ["BESTSELLER"],
                  description: "Gentle cleanser with organic rosehip.",
                  details: ["Organic", "Refreshing"],
                  isNew: false,
                  isBestseller: true,
                  isSale: false,
                  isSoldOut: false,
